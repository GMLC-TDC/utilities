...
TEST(mapops, map1)
{
    ...
    EXPECT_EQ(mapFind(map1,std::string("a"),std::string("string3")),"string1");
    EXPECT_EQ(mapFind(map1,std::string("b"),std::string("string3")),"string2");
    EXPECT_EQ(mapFind(map1,std::string("c"),std::string("string3")),"string3");
}
...
TEST(mapops, umap1)
{
    std::unordered_map<std::string, std::string> map1{ {"a","string1"},{"b","string2"} };
